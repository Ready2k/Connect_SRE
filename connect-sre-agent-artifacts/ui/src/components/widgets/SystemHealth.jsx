...
const data = [
  { name: 'OK', value: 99.98, color: 'var(--status-ok)' },
  { name: 'Warn', value: 0.1, color: 'var(--status-warn)' },
  { name: 'Critical', value: 0.1, color: 'var(--status-critical)' },
];
...
const SystemHealth = () => {
  return (
    <>
      ...
      <div style={{ textAlign: 'center', color: 'var(--status-ok)', fontWeight: 600, fontSize: '1.2rem', marginBottom: '0.5rem' }}>
        99.98% Uptime
      </div>
      <div style={{ flex: 1, position: 'relative', minHeight: '120px' }}>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '1.1rem', fontWeight: 700 }}>99.98%</div>
